function varargout = ode420(ode,tspan,y0,options,varargin)
% this is ODE45 with a quatnormalize
...
while ~done
  ...
  nsteps = nsteps + 1;                  
  ynew(4:7)=quatnormalize(ynew(4:7)')';  
  ...
  if output_sol
    ...
    tout(nout) = tnew;
    yout(:,nout) = ynew;
    yout(4:7,:)=quatnormalize(yout(4:7,:)')'; 
